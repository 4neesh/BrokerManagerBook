...
public class GetBestPriceTest {
  ...
  //    @Test
  //    public void bestBidPriceIsHighestAfterDeleteHighest() {
  //
  //        orderBookManager.deleteOrder(buy1.getOrderId());
  //
  //        Long expectedPrice = buy2.getPrice();
  //        Long actualPrice = orderBookManager.getBestPrice(buy1.getInstrument(),
  // buy1.getSide()).get();
  //        assertEquals("Best bid price is not changed to after highest is deleted", expectedPrice,
  // actualPrice);
  //    }

  //    @Test
  //    public void bestBidPriceIsHighestAfterDeleteNonHighest() {
  //
  //        Order buy4 = new Order("order7", "VOD.L", Side.BUY, 300, 10);
  //        assertTrue(buy4.getPrice() > buy1.getPrice());
  //        assertTrue(buy4.getInstrument() == buy1.getInstrument());
  ...
  //        Long actualPrice = orderBookManager.getBestPrice(buy1.getInstrument(),
  // buy1.getSide()).get();
  //        assertEquals("Best bid price is not changed to higher value", expectedPrice,
  // actualPrice);
  //    }
